      ...
      <main className=" bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="">
          <nav className="py-10 mb-12 flex justify-between">
            <h1 className="text-xl font-burtons ">Shamyrat</h1>
          ...
          <div className="text-center p-10">
            ...
            <h3 className="text-txl py-2 md:text-3xl">FrontEnd Developer</h3>
            <p className="text-md py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto dark:text-white">
              Freelencer providing services for programming and design content
        ...
        <section>
          <div>
            <h3 className="text-xl py-1 dark:text-white">Services I offer</h3>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-white">
              Since the beginning of my journey as a freelece design developer,
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-white">
              I offer from a wide rabge of Services, including programming and
              teaching
            </p>
          </div>
          <div className="lg:flex gap-10 ">
            <div className="text-center shadow-lg p-10 rounded-xl dark:bg-white">
              ...
              <h3 className="text-lg front-medium pt-8 pb-2">
                Beautiful Design
              </h3>
              <p className="py-2">
              ...
              <p className="text-gray-800 py-1">Check GitHub/LinkedIn</p>
              <p className="text-gray-800 py-1">Check GitHub/LinkedIn</p>
              <p className="text-gray-800 py-1">Check GitHub/LinkedIn</p>
            </div>
            <div className="text-center shadow-lg p-10 rounded-xl dark:bg-white">
